"""
Setup file for pipeline_dataflow_2 package - Configures Apache Beam pipeline for processing Walmart data
--------------------------------
...
setup(
    ...
    tests_require=["pytest", "pytest-mock", "apache-beam[test]"],
)
